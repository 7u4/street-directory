package de.debuglevel.streetdirectory.overpass

import io.micronaut.context.annotation.ConfigurationProperties
import java.time.Duration

@ConfigurationProperties("app.street-directory.extractors.overpass")
class OverpassProperties {
     ...
     */
    var userAgent = "github.com/debuglevel/street-directory"
